  ...
  return (
    <div className="space-y-20 pb-12">
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto px-4">
        ...
        {/* CSV to VCF */}
        <div className={`bg-white rounded-2xl p-8 shadow-sm border transition-all group relative overflow-hidden ${pageType === 'csv-to-vcf' ? 'border-blue-500 ring-4 ring-blue-50' : 'border-slate-200 hover:border-blue-300'}`}>
          <div className="relative z-10">
            <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center mb-6">
              <FileText size={28} />
            </div>
            <h3 className="text-xl font-bold text-slate-900 mb-2">CSV to vCard</h3>
        ...
        {/* VCF to CSV */}
        <div className={`bg-white rounded-2xl p-8 shadow-sm border transition-all group relative overflow-hidden ${pageType === 'vcf-to-csv' ? 'border-purple-500 ring-4 ring-purple-50' : 'border-slate-200 hover:border-purple-300'}`}>
          <div className="relative z-10">
            <div className="w-12 h-12 bg-purple-100 text-purple-600 rounded-xl flex items-center justify-center mb-6">
              <ArrowRightLeft size={28} />
            </div>
            <h3 className="text-xl font-bold text-slate-900 mb-2">vCard to CSV</h3>
            <p className="text-slate-500 mb-6 text-sm leading-relaxed">
        ...
        {/* VCF Splitter */}
        <div className={`bg-white rounded-2xl p-8 shadow-sm border transition-all group relative overflow-hidden ${pageType === 'splitter' ? 'border-orange-500 ring-4 ring-orange-50' : 'border-slate-200 hover:border-orange-300'}`}>
          <div className="relative z-10">
            <div className="w-12 h-12 bg-orange-100 text-orange-600 rounded-xl flex items-center justify-center mb-6">
              <Scissors size={28} />
            </div>
            <h3 className="text-xl font-bold text-slate-900 mb-2">VCF Splitter</h3>
            <p className="text-slate-500 mb-6 text-sm leading-relaxed">
